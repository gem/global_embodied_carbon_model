...
Our primary focus is the embodied carbon generated by repair and reconstruction activities following destructive events, such as earthquakes. Hence, we specifically address the directly relevant modules, as outlined in the workflow below: A1-A5, covering all cradle-to-practical-completion activities, and C1-C4, which encompass the end-of-life processes as part of pre-reconstruction activities.
